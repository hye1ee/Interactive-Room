...
export default function Model(props) {
  ...
  //const shoeBottomGeo = useMemo(()=>toConvexProps(nodes.shoe_bottom1.geometry),[nodes]);
  //const shoeTopGeo = useMemo(()=>toConvexProps(nodes.shoe_top1.geometry),[nodes]);

  //const [shoeBottomRef] = useConvexPolyhedron(() => ({ mass: 40, args : shoeBottomGeo, position : [26.6, 6.1, 9], linearDamping: 0.95, angularDamping: 0.95 }));
  //const [shoeTopRef] = useConvexPolyhedron(() => ({ mass: 40, args : shoeTopGeo, position : [26.6, 6.1, 9], linearDamping: 0.95, angularDamping: 0.95 }));
  //const shoeBottomBind = useDragConstraint(shoeBottomRef);

  const shoe1Geo = useMemo(()=>toConvexPolyhedron([[nodes.shoe_bottom1.geometry,[0,0,0]],[nodes.shoe_top1.geometry,[0, 1.65, 1.8]]]), [nodes]);
  const [shoe1Ref] = useConvexPolyhedron(() => ({ mass: 40, args : shoe1Geo, position : [26.6, 6.1, 9], linearDamping: 0.95, angularDamping: 0.95 }));
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh ref={planeRef}>
        <planeBufferGeometry args={[130, 130]}/>
      ...
      />
      <mesh geometry={nodes.image1.geometry} material={nodes.image1.material} position={[-44.75, 66, -32]} />
      ...
      <mesh geometry={nodes.pic_main1.geometry} material={nodes.pic_main1.material} position={[-44.75, 44.5, 35.25]} />

...
export default function Model(props) {
  ...
  const [planeRef] = usePlane(()=>({type :'Static', rotation : [-Math.PI / 2, 0, 0],  position : [0,3.99,0], args:[10,10]}));
  const [shoe1Ref] = useBox(()=>({  mass : (props.physics)&&40 , args: [0.05, 0.05, 0.05], position : [20,0,-25], linearDamping: 0.95, angularDamping: 0.95}));
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group>
        ...
        <mesh  castShadow receiveShadow geometry={nodes.light_stand001.geometry} material={nodes.light_stand001.material} />
        <SpotLight
        castShadow
        target={target}
        penumbra={0.2}
      ...
      <group ref={shoe1Ref} {...shoe1Bind} dispose={null}>
        <group position={[-7,-4,16]}>
      ...
      <group onPointerEnter={()=>setTrashScale(1.3)} scale={trashScale} onPointerLeave={()=>setTrashScale(1)}>
